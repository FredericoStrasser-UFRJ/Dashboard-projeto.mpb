...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(dcc.Dropdown(id="dropdown-par", options=['c-letras', 'r-letras', 'Tipos acordais', 'Categorias funcionais', 'Funções nota-acorde para músicas'], labels= {'search': 'Procurar'}, className="mb-4"),
